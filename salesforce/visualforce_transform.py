...
parser.add_argument("--extensions", help="")
...
html = html.replace('<html lang="en">', '<apex:page showheader="false" sidebar="false" standardStylesheets="false" controller="' + controller + '" extensions="' + extensions + '" >' )
html = html.replace('</html>', '</apex:page>')
html = html.replace('<!doctype html>', '')
html = html.replace('#RESOURCES#', assetsName)
html = html.replace('$SFCONTROLLER', controller)
html = html.replace('$SFEXTENSIONS', extensions)
